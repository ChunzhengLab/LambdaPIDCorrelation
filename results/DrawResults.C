...
void DrawResults() {
  ...
  hDeltaDelta->GetXaxis()->SetTitle("centrality");
  hDeltaDelta->GetXaxis()->SetRangeUser(0,80.);
  ...
  TProfile* pGammaV0C_SS = (TProfile*) fProfileGammaV0C_Lambda_hPos->Clone();
  pGammaV0C_SS ->Add(fProfileGammaV0C_AntiLambda_hNeg, 1);
  TH1D* hGammaV0C_SS = pGammaV0C_SS->ProjectionX();
  hGammaV0C_SS->SetName("hGammaV0C_SS");

  TProfile* pGammaV0A_SS = (TProfile*) fProfileGammaV0A_Lambda_hPos->Clone();
  pGammaV0A_SS ->Add(fProfileGammaV0A_AntiLambda_hNeg, 1);
  TH1D* hGammaV0A_SS = pGammaV0A_SS->ProjectionX();
  hGammaV0A_SS->SetName("hGammaV0A_SS");

  TProfile* pGammaTPC_OS = (TProfile*) fProfileGammaTPC_Lambda_hNeg->Clone();
  pGammaTPC_OS ->Add(fProfileGammaTPC_AntiLambda_hPos, 1);
  TH1D* hGammaTPC_OS = pGammaTPC_OS->ProjectionX();
  hGammaTPC_OS->SetName("hGammaTPC_OS");

  TProfile* pGammaV0C_OS = (TProfile*) fProfileGammaV0C_Lambda_hNeg->Clone();
  pGammaV0C_OS ->Add(fProfileGammaV0C_AntiLambda_hPos, 1);
  TH1D* hGammaV0C_OS = pGammaV0C_OS->ProjectionX();
  hGammaV0C_OS->SetName("hGammaV0C_OS");

  TProfile* pGammaV0A_OS = (TProfile*) fProfileGammaV0A_Lambda_hNeg->Clone();
  pGammaV0A_OS ->Add(fProfileGammaV0A_AntiLambda_hPos, 1);
  ...
  hDeltaGammaTPC->GetXaxis()->SetTitle("centrality");
  hDeltaGammaTPC->GetXaxis()->SetRangeUser(0,80.);
  ...
  hDeltaDeltaLambdaP->GetXaxis()->SetTitle("centrality");
  hDeltaDeltaLambdaP->GetXaxis()->SetRangeUser(0,80.);
  ...
  hDeltaGammaTPCLambdaP->GetXaxis()->SetTitle("centrality");
  hDeltaGammaTPCLambdaP->GetXaxis()->SetRangeUser(0,80.);
