...
void DrawGammaLambdaProton()
{
  ...
  fProfileGamma_Lambda_hPos[0]              = (TProfile*)inputList->FindObject("fProfileGammaTPC_Lambda_Proton");
  fProfileGamma_Lambda_hNeg[0]              = (TProfile*)inputList->FindObject("fProfileGammaTPC_Lambda_AntiProton");
  fProfileGamma_AntiLambda_hPos[0]          = (TProfile*)inputList->FindObject("fProfileGammaTPC_AntiLambda_Proton");
  fProfileGamma_AntiLambda_hNeg[0]          = (TProfile*)inputList->FindObject("fProfileGammaTPC_AntiLambda_AntiProton");

  fProfileGamma_Lambda_hPos[1]              = (TProfile*)inputList->FindObject("fProfileGammaV0C_Lambda_Proton");
  fProfileGamma_Lambda_hNeg[1]              = (TProfile*)inputList->FindObject("fProfileGammaV0C_Lambda_AntiProton");
  fProfileGamma_AntiLambda_hPos[1]          = (TProfile*)inputList->FindObject("fProfileGammaV0C_AntiLambda_Proton");
  fProfileGamma_AntiLambda_hNeg[1]          = (TProfile*)inputList->FindObject("fProfileGammaV0C_AntiLambda_AntiProton");

  fProfileGamma_Lambda_hPos[2]              = (TProfile*)inputList->FindObject("fProfileGammaV0A_Lambda_Proton");
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  legendGamma->AddEntry(hGamma_Lambda_hPos[1],"#Lambda - p","lp");
  legendGamma->AddEntry(hGamma_Lambda_hNeg[1],"#Lambda - #bar{p}","lp");
  legendGamma->AddEntry(hGamma_AntiLambda_hNeg[1],"#bar{#Lambda} - #bar{p}","lp");
  legendGamma->AddEntry(hGamma_AntiLambda_hPos[1],"#bar{#Lambda} - p","lp");
  legendGamma->AddEntry(hGamma_SS[1],"#Lambda - p + #bar{#Lambda} - #bar{p}","lp");
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  TLegend* legendDeltaGammaPlane = new TLegend(0.15,0.55,0.45,0.85);
