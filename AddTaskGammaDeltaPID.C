...
void AddTaskGammaDeltaPID(Int_t gFilterBit = 768,Double_t fPtMin=0.2,Double_t fPtMax=2.0,Double_t fEtaMin=-0.8, Double_t fEtaMax=0.8,Double_t fChi2max=4.0,Int_t gNclustTPC=70, Int_t fparticle=0,Double_t nSigTPC = 3.0, Double_t nSigTOF = 3.0, Bool_t bSkipPileUp=kFALSE, TString sCentEstimator="V0M", Float_t fVzMin = -10.0, Float_t fVzMax = 10.0, TString sTrigger="kINT7", Int_t vnHarmonic=2, TString sDetForEP="TPC", TString sMCfilePath="HijingMC_LHC18q_FB768_DeftCut.root", TString sNUAFilePath = "wgtCharge_NUAFB768NoPUcutRun296244.root", TString sDetWgtsFile = "CalibV0GainCorrectionLHC18q_Oct2021.root", Bool_t bSkipAnalysis=kFALSE, const char *suffix = "")
{
