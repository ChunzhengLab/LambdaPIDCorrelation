...
void runAnalysis()
{
  ...
  else
  {
    ...
    alienHandler->SetAdditionalLibs("AliAnalysisTaskGammaDeltaPID.cxx AliAnalysisTaskGammaDeltaPID.h");
    alienHandler->SetAnalysisSource("AliAnalysisTaskGammaDeltaPID.cxx");
    // select the aliphysics version. all other packages
    // are LOADED AUTOMATICALLY!
    alienHandler->SetAliPhysicsVersion("vAN-20211204_ROOT6-1");
    ...
    alienHandler->SetGridWorkingDir("LambdaP");
